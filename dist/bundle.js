	    ...
	    render: function render() {
	        return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { className: 'btn btn-default', draggable: 'true', onDragStart: this.dragStart, onDragEnd: this.dragEnd, onClick: this.onClick },
	                    'テスト用ボタン'
	                )
	            )
	        );
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _react2.default.createClass({
	    ...
	    render: function render() {
	        onSubmit: return _react2.default.createElement(
	            'div',
	            { className: 'col-md-8' },
	            _react2.default.createElement('iframe', { ref: 'iframe', src: 'iframe-index.html', onDragEnter: this.dragEnter,
